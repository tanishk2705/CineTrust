...
public class MovieAvailabilityServiceTest {
    ...
    @Test
    void testUnlinkAvailability_WrongMovieId() {
        Movie anotherMovie = Movie.builder().title("Tenet").build();
        anotherMovie.setId(99L);
        availability.setMovie(anotherMovie);
        ...
        verify(movieAvailabilityRepository, never()).delete(any());
    }
}
